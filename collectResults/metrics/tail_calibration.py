...
methods = ["hnn","hnn_ensemble","mc_dropout","concrete_dropout","extra","rf",'usnrt']
methods_disp = ["HNN","\\makecell{Deep\\\\Ensemble}","MC Dropout",
           "\\makecell{Concrete\\\\Dropout}","\\makecell{Extra\\\\Trees}",
...
with open("tail_calibration.txt", 'w') as file:
...
all_metrics.to_csv("tail_calibration.csv")
